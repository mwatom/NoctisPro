...
echo "   View Logs:       tail -f /workspace/noctispro_production.log"
echo "   Stop Server:     pkill -f 'manage.py runserver'"
echo "   Restart:         cd /workspace && python3 manage.py runserver 0.0.0.0:8000 &"
echo ""

# Save process ID
echo "DJANGO_PID=$DJANGO_PID" > /workspace/.production_pids
