...
MIDDLEWARE = [
    ...
    # Keep custom middlewares after auth to ensure request.user exists
...
# Channel layers configuration - Use in-memory for stability
CHANNEL_LAYERS = {
    'default': {
...
# Celery Configuration - Disabled for stability
